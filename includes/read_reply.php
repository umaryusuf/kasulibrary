		...
		<?php
			...
			if(isset($_POST["reply"])) {
				if(!empty($_POST["reply_msg"])){
					...
					$sql = mysqli_query($dbc, "INSERT INTO msgs(student_id, sender, content) VALUES('$std_id', '$full_name', '$reply_msg')");
					if ($sql) {
						echo "
...
<div class="row">
	...
	<?php  
		...
		$q = mysqli_query($dbc, "UPDATE msgs SET viewed='1' WHERE student_id='$student_id' AND msg_id='$read'");
		if($q){
		?>
